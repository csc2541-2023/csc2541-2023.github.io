  ...
  return (
    <div className="container">
      <Head>
        ...
        <h5><a href="assignments/projectproposal">Project Proposal (15%)</a></h5>
        <h6>Due: September 28, 2023, at 11:59PM ET.</h6>
        ...
        <h5><a href="assignments/projectpresentation">Project Presentation (20%)</a></h5>
        <h6>Due: Varies based on presentation slot.</h6>
        ...
        <h6>Due: December 7, 2023, at 11:59PM ET.</h6>
